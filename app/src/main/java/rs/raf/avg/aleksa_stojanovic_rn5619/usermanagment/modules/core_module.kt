...
val coreModule = module {
    ...
    single { Room.databaseBuilder(androidContext(), EmployeeDataBase::class.java, "EmployeeDb")
        .fallbackToDestructiveMigration()
        .build() }
    single { Room.databaseBuilder(androidContext(), RecentlyDataBase::class.java, "RecentlyDb")
        .fallbackToDestructiveMigration()
        .build() }
